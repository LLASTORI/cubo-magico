...
## ✅ Sessão 37 cont. — Fixes de exclusão e navegação

- [x] `delete_funnel_safe`: RPC reescrita — deleta todas as 8 tabelas FK + sub-FKs antes do funil ✅
- [x] Migration `20260326200000` aplicada no banco ✅
