      ...
      for (let batchIndex = 0; batchIndex < batches.length; batchIndex++) {
        ...
        for (const row of batch) {
          try {
            ...
            const identityQuestions = questions.filter(q => 
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Importe respostas desta pesquisa a partir de um arquivo CSV. O email é obrigatório.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="border-2 border-dashed rounded-lg p-6 text-center">
              ...
              {!file ? (
                <label htmlFor="csv-upload-local" className="cursor-pointer">
          ...
          {/* Column Mapping */}
          {parsedData.length > 0 && questions.length > 0 && (
            <div className="space-y-4">
