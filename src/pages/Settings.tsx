...
const Settings = () => {
  ...
  const handleConnectMeta = async () => {
    ...
    try {
      ...
      // Note: pages_manage_engagement, instagram_basic, instagram_manage_comments, instagram_manage_insights require App Review
      // Using only permissions available in development mode
